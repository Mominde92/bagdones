...
class OrderController extends Controller
{
    ...
    elseif($status == 'recived'){
        ...
        app('App\Http\Controllers\NotificationController')::sendNotificationToAll($device_token,$title,$body, $title_locale, $description_locale,$order->id,$imagepath,'order');

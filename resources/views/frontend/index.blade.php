              ...
              <div class="nav-left" >
                ...
                <div class="collapse  nav-desk" id="navbarToggleExternalContent">
                  <ul class="nav-cat title-font">
                    <li> <a href="#"><img src="{{ asset('frontend/assets/images/layout-1/nav-img/01.png')}}" alt="category-product"> western ware</a></li>
                    <li> <a href="#"><img src="{{ asset('frontend/assets/images/layout-1/nav-img/02.png')}}" alt="category-product"> TV, Appliances</a></li>
                    <li> <a href="#"><img src="{{ asset('frontend/assets/images/layout-1/nav-img/03.png')}}" alt="category-product"> Pets Products</a></li>
                    <li> <a href="#"><img src="{{ asset('frontend/assets/images/layout-1/nav-img/04.png')}}" alt="category-product"> Car, Motorbike</a></li>
                    <li> <a href="#"><img src="{{ asset('frontend/assets/images/layout-1/nav-img/05.png')}}" alt="category-product"> Industrial Products</a></li>
                    <li> <a href="#"><img src="{{ asset('frontend/assets/images/layout-1/nav-img/06.png')}}" alt="category-product"> Beauty, Health Products</a></li>
                    <li> <a href="#"><img src="{{ asset('frontend/assets/images/layout-1/nav-img/07.png')}}" alt="category-product"> Grocery Products </a></li>
                    <li> <a href="#"><img src="{{ asset('frontend/assets/images/layout-1/nav-img/08.png')}}" alt="category-product"> Sports</a></li>
                    <li> <a href="#"><img src="{{ asset('frontend/assets/images/layout-1/nav-img/09.png')}}" alt="category-product"> Bags, Luggage</a></li>
                    <li> <a href="#"><img src="{{ asset('frontend/assets/images/layout-1/nav-img/10.png')}}" alt="category-product"> Movies, Music </a></li>
                    <li> <a href="#"><img src="{{ asset('frontend/assets/images/layout-1/nav-img/11.png')}}" alt="category-product"> Video Games</a></li>
                    <li> <a href="#"><img src="{{ asset('frontend/assets/images/layout-1/nav-img/12.png')}}" alt="category-product"> Toys, Baby Products</a></li>
                    <li>
                      ...
                      <li>
                        <div class="container">
                          ...
                          <div class="row menu-banner">
                            <div class="col-lg-6">
                              <div>
                                <img src="{{ asset('frontend/assets/images/menu-banner1.jpg')}}" alt="menu-banner" class="img-fluid">
                              </div>
                            </div>
                            <div class="col-lg-6">
                              <div>
                                <img src="{{ asset('frontend/assets/images/menu-banner2.jpg')}}" alt="menu-banner" class="img-fluid">
                              </div>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="container">
                          <div class="row">
                            ...
                            <div class="col mega-box product ">
                              <div class="mega-img">
                                <img src="{{ asset('frontend/assets/images/mega-banner.jpg')}}" alt="menu-banner" class="img-fluid">
                              </div>
                            </div>
                          </div>
                        </div>
            ...
            <div class="category-right">
              ...
              <div class="btn-group">
                ...
                <div class="dropdown-menu gift-dropdown">
                  ...
                  <div class="media">
                    <div  class="me-3">
                      <img src="{{ asset('frontend/assets/images/icon/2.png')}}" alt="Generic placeholder image" class="gift-bloc">
                    </div>
                    <div class="media-body">
                      <h5 class="mt-0">Fashion Discount</h5>
                      <p><img src="{{ asset('frontend/assets/images/icon/fire.png')}}"  class="fire" alt="fire">Extra 10% off (upto Rs. 10,000*) </p>
                    </div>
                  </div>
                  <div class="media">
                    <div  class="me-3">
    ...
    <div class="row">
      <div class="col">
        <div class="slide-1 no-arrow">
          @if($items_store_slider)
          @foreach($items_store_slider as $item_store_slider)
          <div>
            <div class="slider-banner p-center slide-banner-1">
              <div class="slider-img">
                <ul class="layout1-slide-1">
                  <li id="img-1"><img src="{{ asset('uploads/items/' . $item_store_slider->main_screen_image )}}" class="img-fluid" alt="slider"></li>
                  <li id="img-2" class="slide-center"><img src="{{ asset('uploads/items/' . $item_store_slider->main_screen_image )}}" class="img-fluid" alt="slider"></li>
                </ul>
              </div>
              <div class="slider-banner-contain">
                <div>
                  <h1>{{$item_store_slider->name}}</h1>
  ...
  <div class="tab-product-main">
    <div class="tab-prodcut-contain">
      <ul class="tabs tab-title">
        ...
        <li class="current"><a href="tab-1">{{$sub_category_item_name}}</a></li>
        @endif
      </ul>
    </div>
  </div>
                  ...
                  <div class="product-box">
                    <div class="product-imgbox">
                      <div class="product-front">
                        <a href="#">
                          <img src="{{ asset('uploads/items/' . $item->main_screen_image )}}" class="img-fluid" alt="product">
                        </a>
                      </div>
               ...
               @if($items_store)
                  ...
                  <div class="product-box">
                    <div class="product-imgbox">
                      <div class="product-front">
                        <a href="#">
                          <img src="{{ asset('uploads/items/' . $item_store->main_screen_image )}}" class="img-fluid" alt="product">
                        </a>
                      </div>
                      <div class="product-back">
                        <a href="#">
                      ...
                      <div class="new-label1">
                        <div><img src="{{ asset('uploads/stores/' . $item_store->store_image)}}"/></div>
                      </div>
      ...
      <div class="col">
        ...
        <div class="collection-banner-main banner-5 p-center">
          <div class="collection-img">
            <img src="{{asset('uploads/items/' . $item_id->main_screen_image)}}" class="bg-img  " alt="banner">
          </div>
          <div class="collection-banner-contain ">
            <div class="sub-contain">
              <h4>{{$item_id->name}}</span></h4>
              <div class="shop">
        ...
        <div class="slide-6 no-arrow">
            ...
            <div class="category-contain">
              <div class="img-wrapper">
                <a href="#">
                  <img src="{{asset('uploads/category/' . $Category->image)}}" alt="category" class="img-fluid">
                </a>
              </div>
        ...
        <div class="row">
          <div class="col-lg-6 col-xs-12">
            <div class="quick-view-img">
              <img src="{{ asset('frontend/assets/images/layout-1/product/3.jpg') }}" alt="" class="img-fluid bg-img">
            </div>
          </div>
          ...
          <div class="product-img">
            <div class="media">
              <div class="img-wraper">
                <a href="product-page(left-sidebar).html">
                  <img src="{{ asset('frontend/assets/images/layout-2/product/1.jpg') }}" alt="">
                </a>
              </div>
              <div class="media-body">
                <a href="product-page(left-sidebar).html">
    ...
    <div class="cart_media">
      <ul class="cart_product">
        ...
        <li>
          <div class="media">
            <a href="product-page(left-sidebar).html">
              <img alt="megastore1" class="me-3" src="{{ asset('frontend/assets/images/layout-2/product/2.jpg') }}">
            </a>
            <div class="media-body">
              <a href="product-page(left-sidebar).html">
        ...
        <li>
          <div class="media">
            <a href="product-page(left-sidebar).html">
              <img alt="megastore1" class="me-3" src="{{ asset('frontend/assets/images/layout-2/product/3.jpg') }}">
            </a>
            <div class="media-body">
              <a href="product-page(left-sidebar).html">

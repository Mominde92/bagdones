...
<div class="card card-custom example example-compact">
    ...
    <form action="{{ url('items/update' , $item) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="card-body">
            ...
            <div class="col-lg-4">
            <div class="card">
            <img src="{{asset('/uploads/items/'.$item->cover_image)}}" class="embed-responsive card-img-top">
            <input type="hidden" name="item_id" class="item_id" value="{{asset('../uploads/items/'.$item->cover_image)}}" />
            </div>
            </div>
